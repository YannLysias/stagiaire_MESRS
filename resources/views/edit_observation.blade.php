            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <form class="" action="{{ route('observation.update', $observation->id)}}" method="post" enctype="multipart/form-data" novalidate>
                                @csrf
                                @if ($observation)
                                @method('PUT')
                        <div class="body">
                            <div class="form-group">
                                ...
                                <input type="text" name="description" value="{{$observation->description}}" class="form-control" id="description">                            </div>
                            @error('description')
                                <div class="d-block text-danger">{{$message}}</div>
                            @enderror
                            <input type="hidden" name="stage_id" value="{{ $observation->id }}">
