            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form class="" action="{{ route('structure.update', $structure->id)}}" method="post" enctype="multipart/form-data" novalidate>
                                @csrf
                                @if ($structure)
                                @method('PUT')
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="email_address" value="{{$structure->code_structure}}" name="code_structure" class="form-control" placeholder="Entrer le nom de la structure">
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="password" value="{{$structure->libelle}}" name="libelle" class="form-control" placeholder="Entrer le code de la structure">
                                    </div>
                                    @error('libelle')
                                        <div class="d-block text-danger">{{$message}}</div>
                                    @enderror
