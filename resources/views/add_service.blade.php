                        ...
                        <div class="body">
                            <form method="POST" action="/service">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text"value="{{ old('code_service') }}"  name="code_service" id="email_address" class="form-control" placeholder="Entrer le nom de la service">
                                    </div>
                                    @error('code_service')
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" value="{{ old('libelle') }}"  id="password" name="libelle" class="form-control" placeholder="Entrer le code de la service">
                                    </div>
                                    @error('libelle')
                                        <div class="d-block text-danger">{{$message}}</div>
                                    @enderror
                                ...
                                <div class="body">
                                    <div class="row clearfix ">
                                            ...
                                            <div class="form-group">
                                                <div class="form-line">
                                            <select class="form-control show-tick" value="{{ old('structure_id') }}"  name="structure_id">
