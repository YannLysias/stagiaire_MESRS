                        ...
                        <div class="body">
                            <form method="POST" action="/document" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text"  value="{{ old('titre') }}" id="email_address" name="titre" class="form-control" placeholder="Entrer le thème de votre document">
                                    </div>
                                    @error('titre')
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="file" id="password" value="{{ old('fichier') }}" name="fichier" class="form-control" placeholder="Entrer le code de la structure">
                                    </div>
                                    @error('fichier')
                                        <div class="d-block text-danger">{{$message}}</div>
                                    @enderror
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <select class="form-control show-tick" value="{{ old('type') }}" name="type">
                                            <option value="" selected>-- Choisir type de document --</option>
                                            <option value="Rapport de stage">Rapport de stage</option>
                                            <option value="Memoire de fin de formation">Memoire de fin de formation</option>
                                        </select>
                                    </div>
                                    @error('type')
                                        <div class="d-block text-danger">{{$message}}</div>
