                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($stagiaire->stages->isNotEmpty())
                                                    <a href="{{ route('observation.create', ['stage_id' => $stagiaire->stages->first()->id]) }}" class="btn btn-success">
                                                        <i class="fas fa-eye"></i> obs
                                                    </a>
                                                @endif 
                                                <a href="{{ route('stagiaire-profile.show1', ['id' => $stagiaire->id]) }}" class="btn btn-info btn-sm info-button">
